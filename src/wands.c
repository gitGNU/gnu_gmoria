...
aim ()
{
  ...
  else if (get_item (&item_val, "Aim which wand?", j, k, NULL, NULL))
    {
	  ...
	  else if (i_ptr->p1 > 0)
	    {
		  ...
		  switch (j)
		    ...
		    case 19:
		      ...
		      break;
		    case 20:
		      fire_ball (GF_FIRE, dir, k, l, 72, spell_names[0][28]);
		      ident = TRUE;
		      break;
		    case 21:
		      fire_ball (GF_POISON_GAS, dir, k, l, 12,
				 spell_names[0][6]);
		      ident = TRUE;
		      break;
		    case 22:
