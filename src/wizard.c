...
change_character ()
{
  ...
  snprintf (tmp_str, sizeof (tmp_str), "Current=%ld  Gold = ", m_ptr->au);
  ...
  snprintf (tmp_str, sizeof (tmp_str),
	    "Current=%d  (0-200) Searching = ", m_ptr->srh);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  ...
  snprintf (tmp_str, sizeof (tmp_str),
	    "Current=%d  (-1-18) Stealth = ", m_ptr->stl);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  if (get_string (tmp_str, 0, tmp_val, 3))
    {
  ...
  snprintf (tmp_str, sizeof (tmp_str),
	    "Current=%d  (0-200) Disarming = ", m_ptr->disarm);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  if (get_string (tmp_str, 0, tmp_val, 3))
    {
  ...
  snprintf (tmp_str, sizeof (tmp_str),
	    "Current=%d  (0-100) Save = ", m_ptr->save);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  if (get_string (tmp_str, 0, tmp_val, 3))
    {
  ...
  snprintf (tmp_str, sizeof (tmp_str),
	    "Current=%d  (0-200) Base to hit = ", m_ptr->bth);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  if (get_string (tmp_str, 0, tmp_val, 3))
    {
  ...
  snprintf (tmp_str, sizeof (tmp_str),
	    "Current=%d  (0-200) Bows/Throwing = ", m_ptr->bthb);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  if (get_string (tmp_str, 0, tmp_val, 3))
    {
  ...
  snprintf (tmp_str, sizeof (tmp_str), "Current=%d  Weight = ", m_ptr->wt);
  tmp_val = strlen (tmp_str);
  prt (tmp_str, 0, 0);
  if (get_string (tmp_str, 0, tmp_val, 3))
    {
...
wizard_create ()
{
  ...
  snprintf (pattern, sizeof (pattern), "%s", "%lx");
